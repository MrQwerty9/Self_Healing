...
import kotlinx.android.synthetic.main.item_quiz_locus.view.*
...
class LocusAdapter(private var context: Context) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_quiz_locus, null)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (number in locusPositive) { //quiz positive
            holder.rbLocusY.setOnCheckedChangeListener { _, _ ->
                locusInput[position] = 2
            }
            holder.rbLocusN.setOnCheckedChangeListener { _, _ ->
